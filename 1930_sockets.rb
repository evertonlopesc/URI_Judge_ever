...
# da Maratona de Programação da SBC. Os três membros do time e o técnico 
# estão ansiosos para bem representar a Universidade, 
# e além de treinar muito, preparam com todos os detalhes a sua viagem a São Paulo, 
...
# e sabem que necessitarão de várias tomadas de energia para conectar 
# todos esses equipamentos. Eles foram informados de que ficarão os quatro 
# no mesmo quarto de hotel, mas já foram alertados de que em cada quarto há apenas 
...
# o número de tomadas disponíveis. No entanto, como as réguas têm muitas tomadas, 
...
#socket = gets.split
#socket.map! { |string| string.to_i }
#
#count = 0
#result = -3
#
#while count < (socket.count)
#  result += socket[count]
#  count += 1
#end
#
...
socket.each { |count| result += count }
