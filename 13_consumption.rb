...
car_km = gets
raise StandardError, 'Expected a number' if car_km =~ /^[a-zA-Z]/

car_liters = gets
raise StandardError, 'Expected a number' if car_liters =~ /^[a-zA-Z]/

result = car_km.to_i / car_liters.to_f

puts format('%.3f km/l', result)
